...
class PLASMANM_CELLULAR_EXPORT CellularAvailableNetwork : public QObject
{
    Q_OBJECT
    QML_ELEMENT
...
public:
    CellularAvailableNetwork(QObject *parent = nullptr,
                             ModemManager::Modem3gpp::Ptr mm3gppDevice = nullptr,
                             bool isCurrentlyUsed = false,
                             QString operatorLong = QString(),
                             QString operatorShort = QString(),
...
class PLASMANM_CELLULAR_EXPORT CellularModemDetails : public QObject
{
    Q_OBJECT
    QML_ELEMENT
    Q_PROPERTY(QStringList accessTechnologies READ accessTechnologies NOTIFY accessTechnologiesChanged)
    ...
    Q_PROPERTY(QList<CellularAvailableNetwork *> networks READ networks NOTIFY networksChanged)
...
public:
    CellularModemDetails(QObject *parent = nullptr, CellularModem *modem = nullptr);
    ...
    QList<CellularAvailableNetwork *> networks();
...
private:
    ...
    QList<CellularAvailableNetwork *> m_cachedScannedNetworks;
};
